...
const Cart = () => {
  ...
  // Simulating a loading delay for data fetching
  useEffect(() => {
  ...
  return (
    <div className="container row ml-8">
      <h1 className="text-2xl font-bold text-left" style={{ marginTop: '50px', marginBottom: '50px', marginLeft: '10px' }}>Shopping Cart</h1>
      ...
      <div className="container mx-auto flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2 md:pr-4 bg-neutral-100 rounded-lg">
          {loading ? (
            ...
            <p>Your cart is currently empty.</p> // Show empty cart message
          )}
        </div>
      ...
      <article className="bg-neutral-100 mt-10 p-4 rounded-lg px-4">
